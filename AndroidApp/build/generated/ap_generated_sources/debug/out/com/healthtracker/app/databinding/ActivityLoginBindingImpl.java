...
public class ActivityLoginBindingImpl extends ActivityLoginBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tvAppName, 2);
        ...
        sViewsWithIds.put(R.id.dividerContainer, 11);
        sViewsWithIds.put(R.id.btnGoogle, 12);
        sViewsWithIds.put(R.id.btnFacebook, 13);
        sViewsWithIds.put(R.id.tvSignUp, 14);
    }
    // views
    @NonNull
