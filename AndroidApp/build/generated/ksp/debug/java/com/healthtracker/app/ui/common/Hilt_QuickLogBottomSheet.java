...
public abstract class Hilt_QuickLogBottomSheet extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_QuickLogBottomSheet() {
    super();
  }

  Hilt_QuickLogBottomSheet(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((QuickLogBottomSheet_GeneratedInjector) this.generatedComponent()).injectQuickLogBottomSheet(UnsafeCasts.<QuickLogBottomSheet>unsafeCast(this));
    }
  }
