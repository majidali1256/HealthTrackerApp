...
public abstract class Hilt_AddMedicationBottomSheet extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddMedicationBottomSheet() {
    super();
  }

  Hilt_AddMedicationBottomSheet(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddMedicationBottomSheet_GeneratedInjector) this.generatedComponent()).injectAddMedicationBottomSheet(UnsafeCasts.<AddMedicationBottomSheet>unsafeCast(this));
    }
  }
